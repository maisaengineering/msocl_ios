...
- (void)setupLabel {
    ...
    _attributesHashtag = @{NSForegroundColorAttributeName: [[UIColor alloc] initWithRed:76/255.0 green:121/255.0 blue:256/255.0 alpha:1.0], NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:12.0]};
