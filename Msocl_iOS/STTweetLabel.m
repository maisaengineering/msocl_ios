...
- (void)setupLabel {
    ...
    _attributesHashtag = @{NSForegroundColorAttributeName: [[UIColor alloc] initWithRed:0/255.0 green:122/255.0 blue:255/255.0 alpha:1.0], NSFontAttributeName: [UIFont fontWithName:@"Ubuntu-Light" size:15.0]};
