...
- (void)setupLabel {
    ...
    _attributesHashtag = @{NSForegroundColorAttributeName: [[UIColor alloc] initWithRed:136/255.0 green:136/255.0 blue:136/255.0 alpha:1.0], NSFontAttributeName: [UIFont fontWithName:@"SanFranciscoText-Light" size:10.0]};
